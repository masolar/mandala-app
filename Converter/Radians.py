...
"""
def cart_to_polar(x, y, origin=(0, 0)):
...
def polar_to_cart(r, theta, origin=(0, 0)):
    # Have to use a negative y because of the coordinate system of the canvas
...
def rotate_line(line, rot_amount, origin = (0, 0)):
    ...
    end_1 = cart_to_polar(x_1, y_1, origin)
    end_2 = cart_to_polar(x_2, y_2, origin)
